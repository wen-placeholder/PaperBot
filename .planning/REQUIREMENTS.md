...
- [ ] **MCP-01**: Agent can analyze trends across a set of papers via `analyze_trends` MCP tool
- [ ] **MCP-02**: Agent can check a scholar's recent publications and activity via `check_scholar` MCP tool
